...
namespace EQMS.Checkout
{
    ...
    internal class CheckoutDAO : ICheckoutDAO
    {
        public string _connectionString { get; }

        public CheckoutDAO(string _connectionString)
        {
        ...
        public DataTable GetData(string query)
        {
            ...
            using (SqlConnection connection = GetConnection())
            {
                ...
                {
                    MessageBox.Show("An error occurred: ARI " + ex.Message, "Error", MessageBoxButton.OK, MessageBoxImage.Error);
                }
            }
